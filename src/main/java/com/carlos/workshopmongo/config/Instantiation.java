...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... arg0) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/07/2024"), "Partiu Viajem", "Vou viajar para Sao Paulo!",
				new AuthorDTO(maria));
		
		Post post2 = new Post(null, sdf.parse("22/07/2024"), "Bom dia", "Arcodei feliz hoje!", new AuthorDTO(maria));
		
		CommentDTO c1 = new CommentDTO("Boa viagem mano!",sdf.parse("21/07/2024"), new AuthorDTO(alex));
		CommentDTO c2 = new CommentDTO("Aproveite!",sdf.parse("21/07/2024"), new AuthorDTO(bob));
		CommentDTO c3 = new CommentDTO("tenha um otimo dia!",sdf.parse("21/07/2024"), new AuthorDTO(alex));
